...
# Leistungsabnahme des Moduls ueber 20 Jahre durchschnittlich 0,05% = 20 * 0,005% = 10%. Wenn die Abnahme Ã¼ber 20 Jahre 10 % ist, dann kann man den Startwert der Module * 95% rechnen.
module_reduce = 0.95

# Quadratmeter fÃ¼r 1 kWp
m2kwp = 5.2
