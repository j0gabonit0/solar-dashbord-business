...
slpc_r <- read_delim("C:/Users/corvi/Nextcloud/04_PV/07_Projekte/Dorsten_STursula/Realschule/stursula_real_slp.csv", delim = ";")
sedn_r <- read_delim("C:/Users/corvi/Nextcloud/17_solar_dashbord/solar-dashbord-business/solar_europe_de_nuts.csv", delim = ",")
sedn_t <- sedn_r %>%
